...
public class LottoController {
    ...
    public void run() {
        ...
        WinningLottoNumbers winningLottoNumbers = retryInputBonusNumber(winningNumbers);
    ...
    private WinningLottoNumbers retryInputBonusNumber(List<Integer> winningNumbers) {
        while (true) {
            try {
